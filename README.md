...
# Amulya Bhardwaj :rocket:
### Final Year Student at IIIT Ranchi | Software Engineering Aspirant

<img src="https://readme-typing-svg.demolab.com?font=Space+Grotesk&weight=700&size=24&duration=2200&pause=900&center=true&vCenter=true&width=780&lines=Code.+Create.+Ship.;Full-Stack+Builder+%7C+Problem+Solver;Open+to+SDE+Internships+%26+Full-Time+Roles" alt="Typing SVG" />
...
<img src="https://img.shields.io/badge/Focus-Full%20Stack%20Development-f97316?style=for-the-badge" alt="focus" />
...
- Hands-on with full-stack project development :globe_with_meridians:
- Prefer clean architecture, maintainable code, and shipping real outcomes :gear:
- Looking for `SDE Internships` and `Full-Time Software Engineering Roles` :briefcase:
- I love exhausting AI tools as well, haha :robot:
...
<img src="https://skillicons.dev/icons?i=cpp,c,python,javascript,typescript,html,css,react,nodejs,express,mongodb,mysql,git,github,vscode&perline=8" alt="tech stack" />
...
### Keep building. Keep learning. Keep shipping. :fire:
